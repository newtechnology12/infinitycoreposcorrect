...
export function AssetCategoriesFormModal({
  open,
  setOpen,
  record,
  onComplete,
  ...
  async function onSubmit(values: z.infer<typeof formSchema>) {
    ...
    const q = !record
      ...
      : pocketbase.collection("assets_categories").update(record.id, data);
    ...
    return q
      .then(async (e) => {
        ...
        toast.error(
          q
            ? "Asset category updated succesfully"
            : "Asset category  created succesfully"
        );
        form.reset();
      })
      .catch((e) => {
        ...
        <DialogHeader>
          <DialogTitle>
            <span className="text-base px-2 font-semibold py-2">
              {record ? "Update" : "Create a new"} asset category.
            </span>
          </DialogTitle>
          <DialogDescription>
